...
```
Once the file was ready, I created a map from the data. To provide some perspective, this first map is the average number of clicks by county. It shows where the highest pay-per-click activity is occurring for ULoop.
```{r}
